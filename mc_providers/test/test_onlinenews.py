...
@pytest.mark.skipif(IN_GITHUB_CI_WORKFLOW, reason="requires VPN tunnel to Media Cloud Elastic Cluster")
class OnlineNewsMediaCloudProviderTest(unittest.TestCase):
    ...
    def test_all_items(self):
        # make sure overall count matches number of stories found via paging
        query = "trump"
    ...
    def test_overlarge_language(self):
        ...
        # the domain order won't affect the output at all.
