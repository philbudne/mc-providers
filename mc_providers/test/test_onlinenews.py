...
class OnlineNewsWaybackMachineProviderTest(unittest.TestCase):
    ...
    def test_count_over_time(self):
        results = self._provider.count_over_time("coronavirus", dt.datetime(2022, 3, 1), dt.datetime(2022, 4, 1))
    ...
    def test_date_clause(self):
        results = self._provider.sample("coronavirus", dt.datetime(2022, 3, 1), dt.datetime(2022, 4, 1))
        assert len(results) > 0
        for r in results:
            assert r['publish_date'].year == 2022
    ...
    def test_overlarge_sources(self):
        ...
        assert len(results_shuffled) == 51
